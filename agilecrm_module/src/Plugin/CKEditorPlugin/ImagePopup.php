...
namespace Drupal\agilecrm_module\Plugin\CKEditorPlugin;
...
class ImagePopup extends CKEditorPluginBase implements CKEditorPluginConfigurableInterface {
  ...
  public function getFile() {
    return drupal_get_path('module', 'agilecrm_module') . '/js/plugins/imagepopup/plugin.js';
  }
  ...
  public function getButtons() {
    return array(
       'FormBuilder' => array(
        'label' => t('Agile Form Builder'),
        'image' => drupal_get_path('module', 'agilecrm_module') . '/js/plugins/colorbutton/icons/googleforms.png',
      ),
      'Landingpage' => array(
        'label' => t('Agile Landing Page'),
        'image' => drupal_get_path('module', 'agilecrm_module') . '/js/plugins/colorbutton/icons/browser.png',
      )
    );
  }
